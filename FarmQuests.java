 ...
 * Mỗi quest là một lớp inner-static kế thừa {@link Quest}.
 */
public final class FarmQuests {
    ...
    /*  Tutorial quest: gieo 5 hạt lúa mì                                 */
    /* ================================================================== */

    public static class FirstMorningQuest extends Quest {

        public FirstMorningQuest() {
            super(
                "quest_first_morning",
                "Buổi Sáng Đầu Tiên",
        ...
        @Override
        protected List<QuestObjective> buildObjectives() {
        ...
        @Override
        protected QuestReward buildReward() {
            return new QuestReward.Builder()
                    .gold(20)
    ...
    public static class FirstHarvestQuest extends Quest {
    ...
    /*  Thu hoạch đủ 5 cà chua + 5 ngô + 5 xà lách                       */
    /* ================================================================== */

    public static class SummerFeastQuest extends Quest {

        public SummerFeastQuest() {
            super(
                "quest_summer_feast",
                "Bữa Tiệc Mùa Hè",
    ...
    /*  Gieo hạt 20 lần bất kỳ + tưới nước 20 lần                        */
    /* ================================================================== */

    public static class DiligentFarmerQuest extends Quest {

        public DiligentFarmerQuest() {
            super(
        ...
        protected List<QuestObjective> buildObjectives() {
            return Arrays.asList(
                new Objectives.PlantObjective(20),  // bất kỳ loại hạt
    ...
    /*  Thu hoạch 10 củ cải + 10 bắp cải trước mùa đông                  */
    /* ================================================================== */

    public static class WinterPreparationQuest extends Quest {

        public WinterPreparationQuest() {
            super(
                "quest_winter_prep",
                "Mùa Đông Sắp Đến",
