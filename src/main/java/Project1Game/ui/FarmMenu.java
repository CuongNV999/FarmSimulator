...
public class FarmMenu extends FXGLMenu {
    ...
    public FarmMenu(MenuType type) {
        ...
        // 3. Create Title
        Text titleText = new Text(type == MenuType.MAIN_MENU ? "FARM SIMULATOR" : "GAME PAUSED");
        titleText.setFont(Font.font("Arial", FontWeight.EXTRA_BOLD, 60));
        titleText.setFill(Color.web("#eccb58")); // Rich gold color
        DropShadow titleGlow = new DropShadow(25, Color.rgb(100, 255, 120, 0.6));
        titleText.setEffect(titleGlow);

        // Subtitle or description
        Text subtitleText = new Text(type == MenuType.MAIN_MENU ? "Version 2.5 - Professional Edition" : "Press ESC to resume");
        subtitleText.setFont(Font.font("Arial", FontWeight.BOLD, 16));
        subtitleText.setFill(Color.web("#a0bfa7")); // Pastel green

        VBox titleContainer = new VBox(10, titleText, subtitleText);
