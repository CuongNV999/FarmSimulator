...
public enum CropData {
    ...
    LETTUCE (EntityType.LETTUCE, "Crops/OldCrops/lettuce/",  4,  30, 2),
    TOMATO  (EntityType.TOMATO,  "Crops/OldCrops/tomato/",  10,  60, 4),
    CORN    (EntityType.CORN,    "Crops/OldCrops/corn/",     8,  70, 3),
